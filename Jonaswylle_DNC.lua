...
function init_gear_sets()
    ...
    sets.precast.Step['Feather Step'] = set_combine(sets.precast.Step, {feet="Macu. Toe Shoes +3"})
    ...
    sets.precast.WS['Aeolian Edge'] = {
		...
		legs={ name="Nyame Flanchard", augments={'Path: B',}},
		--feet={ name="Nyame Sollerets", augments={'Path: B',}},
		feet={ name="Herculean Boots", augments={'Attack+7','Pet: STR+3','"Treasure Hunter"+1','Accuracy+2 Attack+2',}},
		neck="Sibyl Scarf",
    ...
    sets.defense.MDT = sets.defense.DT
...
function handle_equipping_gear(playerStatus, eventArgs)
    check_gear()
    update_combat_form()
    determine_haste_group()
    check_moving()
